...
namespace lastchose.Controllers
{
	public class HomeController : Controller
	{
		...
		public ActionResult Index()
		{
			...
			objHomeModel.ListCategory = objWebsiteBanHangEntities1.Categories.ToList();
			objHomeModel.ListProducts = objWebsiteBanHangEntities1.Products.ToList();
